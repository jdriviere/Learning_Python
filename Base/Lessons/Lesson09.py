...
print ('Your current Farenheit temperature is {0} if your Kelven temperature is {1}'.format (Kelvin_to_Farenheit (a), a))
print ('If your temperature is', b, '...')
print ('Your current Farenheit temperature is {0} if your Kelven temperature is {1}'.format (Kelvin_to_Farenheit (b), b))
print ('If your temperature is', c, '...')
print ('Your current Farenheit temperature is {0} if your Kelven temperature is {1}'.format (Kelvin_to_Farenheit (c), c))
...
# 'except name_of_excetion_error:' will try to execute whatever code is
